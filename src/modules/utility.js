...
module.exports = {
  ...
  commands: ['setup', 'wizard', 'template', 'lingua', 'permessi', 'embed', 'costruisci', 'evento', 'giveaway', 'poll', 'suggest', 'inviti', 'serverinfo', 'analytics', 'avatar', 'profilo', 'remind', 'snipe', 'export', 'selfimprove', 'traduci', 'userinfo'],
